...
const getAllUsers = async (req, res) => {
  try {
    // Fetch all users from the register collection
    const users = await usermodel.find();
    // console.log(users)
...
//deleteuser=/api/v1/auth/deleteuser
...
//userrole = api/v1/auth/updateuserrole
...
module.exports = { Register, Login, getStations, getuser, updateLocation, getAllUsers, deleteUser, updateUserRole };
